...
/* Точный набор пресетов оверлея из v1.2.4. */
export const OVERLAY_PRESETS: Style<OverlayConfig>[] = [
  {
    id: "glass", name: "Стекло", desc: "Inter · размытая подложка",
    swatch: ["#ffffff", "rgba(8,10,16,0.55)"], font: INTER,
    patch: {
  ...
  {
    id: "ghost", name: "Призрак", desc: "без подложки, тень текста",
    swatch: ["#ffffff", "transparent"], font: INTER,
    patch: {
  ...
  {
    id: "hud", name: "HUD", desc: "моно · как игровой интерфейс",
    swatch: ["#22d3ee", "rgba(8,10,16,0.75)"], font: MONO,
    patch: {
  ...
  {
    id: "compact", name: "Компакт", desc: "Oswald · узкая полоса",
    swatch: ["#a78bfa", "rgba(8,10,16,0.7)"], font: OSWALD,
    patch: {
  ...
  {
    id: "events", name: "События", desc: "только донаты и сабы",
    swatch: ["#f59e0b", "rgba(8,10,16,0.65)"], font: NUNITO,
    patch: {
  ...
  {
    id: "cinema", name: "Кино", desc: "крупно, строки исчезают",
    swatch: ["#fde68a", "rgba(8,10,16,0.45)"], font: SERIF,
    patch: {
