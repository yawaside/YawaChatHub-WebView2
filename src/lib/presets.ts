...
export const FEED_STYLES: Style<ChatViewConfig>[] = [
  {
    id: "rust",
    name: "Rust",
    desc: "выживание: моно, плотно, без подложки",
    swatch: ["#ce422b", "#0f0d0b"],
    font: MONO,
    patch: {
      styleId: "rust", density: "compact", fontSize: 13, fontFamily: "mono", spacing: 2,
...
export const WIDGET_STYLES: Style<WidgetConfig>[] = [
  {
    id: "rust",
    name: "Rust",
    desc: "моно с обводкой, без фона",
    swatch: ["#ce422b", "transparent"],
    font: MONO,
    patch: {
...
export const OVERLAY_STYLES: Style<OverlayConfig>[] = [
  {
    id: "rust",
    name: "Rust",
    desc: "моно, тёмная полупрозрачная подложка",
    swatch: ["#ce422b", "rgba(15,13,11,0.6)"],
    font: MONO,
    patch: {
      styleId: "rust", backdropOpacity: 0.6, textOpacity: 1, radius: 0, accentBar: false,
      shadowText: true, fontFamily: "mono", fontSize: 13, spacing: 2, nickCase: "normal",
    },
  },
  {
    id: "wot",
