...
export const FEED_STYLES: Style<ChatViewConfig>[] = [
  {
    ...
    font: OSWALD,
    patch: {
      // В Rust чат — строки поверх экрана: подложки нет, шрифт плотный
      // и ЖИРНЫЙ, с чёрной обводкой для читаемости на любом фоне.
      styleId: "rust", density: "tight", fontSize: 15, fontFamily: "gaming", spacing: 1,
...
export const WIDGET_STYLES: Style<WidgetConfig>[] = [
  {
    ...
    font: OSWALD,
    patch: {
      styleId: "rust", transparent: true, outlines: true, outlineWidth: 3, theme: "dark",
...
export const OVERLAY_STYLES: Style<OverlayConfig>[] = [
  {
    ...
    patch: {
      ...
      shadowText: true, outlineWidth: 3, fontFamily: "gaming", fontSize: 16, spacing: 1, nickCase: "normal",
    },
  },
  {
    id: "wot",
