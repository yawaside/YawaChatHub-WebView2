  ...
  return (
    ...
    >
      ...
      <div className="app-no-drag flex items-center gap-1">
        ...
        <IconBtn icon={Minus} title="Свернуть" onClick={() => toast("Сворачивание доступно в desktop-сборке")} />
        <IconBtn icon={Square} title="Развернуть" onClick={() => toast("В браузере окно всегда развёрнуто")} />
        <IconBtn icon={X} title="Закрыть" onClick={() => toast("В desktop крестик закрывает окно или прячет в трей")} danger />
      </div>
    </header>
  );
}
