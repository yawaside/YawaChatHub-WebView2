...
import { isDesktop, onHostEvent, ttsBridge, windowCtl, applyHotkeys, channelsApi, overlayBridge, runModerationOnPlatform } from "../lib/bridge";
...
export default function DesktopApp() {
  ...
  const runModeration = useCallback(
    (action: string, msg: ChatMsg, arg?: number) => {
      ...
      // ГЛАВНОЕ: выполняем действие НА ПЛОЩАДКЕ, а не только в ленте.
