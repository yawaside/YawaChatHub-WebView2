...
export function WidgetPanel() {
  const { settings, patch, messages, publishMsg, widgetClients, toast, demo } = useApp();
  ...
  const sendTest = () => {
    ...
    publishMsg(makeMsg(pl, "obs-test", "widget_test", "Тест виджета OBS: смайлы и текст на месте Kappa"));
