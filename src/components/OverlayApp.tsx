...
export default function OverlayApp() {
  ...
  /* размещение: свободное (окно уже спозиционировано хостом) или по углу */
  const placement: React.CSSProperties = c.freePosition
    ? { inset: 0 }
    : {
        ...(c.corner.startsWith("top") ? { top: c.offsetY } : { bottom: c.offsetY }),
        ...(c.corner.endsWith("left") ? { left: c.offsetX } : { right: c.offsetX }),
        width: c.width,
        maxWidth: "95vw",
      };
