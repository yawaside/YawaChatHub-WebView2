...
export default function ChatBotPanel({ toast }: { toast: (t: string) => void }) {
  ...
  // ID приложения VK хранится в настройках хоста и читается при входе
      ...
      >
        ...
        <div className="pt-2.5">
          <label className="mb-1 block text-[11px]" style={{ color: "var(--dw-dim)" }}>
            ID приложения VK (Standalone) — нужен для входа VK
          </label>
          <TextInput
            value={vkClientId}
          ...
          <p className="pt-1 text-[10.5px] leading-snug" style={{ color: "var(--dw-dim)" }}>
            Создайте приложение на vk.com/editapp?act=create с типом Standalone и вставьте его ID сюда.
          </p>
        </div>
