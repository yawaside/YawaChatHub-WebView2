...
import {
  AudioLines, Cpu, Filter, Gamepad2, Keyboard, LayoutList,
  MonitorPlay, ScrollText, Search, Volume2, X,
} from "lucide-react";
...
/* Вкладка «Вывод» убрана: порт и доступ виджета живут в разделе «Виджет OBS».
   Вкладка «Интерфейс» убрана: тема переключается прямо из шапки окна. */
