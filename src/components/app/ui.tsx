    ...
    <div>
      ...
      >
        <div className="min-w-0">
          <div className="truncate text-[12.5px]" style={{ color: "var(--dw-text)" }}>
            {label}
          </div>
          {hint && (
            <div className="truncate text-[11px]" style={{ color: "var(--dw-dim)" }}>
              {hint}
            </div>
          )}
        </div>
  ...
  return (
    ...
    >
      {title && (
        ...
        >
          {icon}
          <h3 className="text-[12.5px] font-semibold tracking-wide" style={{ color: "var(--dw-text)" }}>
            {title}
          </h3>
