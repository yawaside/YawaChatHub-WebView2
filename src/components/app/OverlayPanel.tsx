      ...
      <Collapsible title="Окно оверлея" hint={cfg.locked ? "зафиксировано" : "можно двигать"}>
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[10.5px] leading-snug" style={{ color: "var(--dw-dim)" }}>
            Тяните оверлей мышью в любое место экрана. После фиксации окно остаётся на месте.
          </p>

          <ToggleRow
            label="Сквозной клик"
            hint="нажатия мыши проходят сквозь оверлей в игру; в этом режиме окно нельзя двигать. По умолчанию выключен, быстрый переключатель — хоткей «Сквозной клик оверлея»"
