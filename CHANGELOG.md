...
- Исправлены: изменение размера окна (WebView2 больше не закрывает WPF-рамку), перетаскивание оверлея, доставка сообщений в оверлей (рассылка по всем мостам), остановка коннекторов при удалении канала, URL YouTube (@handle)
