...
- CI: релиз выходил без exe — шаги desktop/NSIS ссылались на несуществующий `desktop/`; workflow теперь авто-детектит desktop (`hashFiles('desktop/**')`), проверка `test -f dist/index.html` убрана
