...
public sealed class ConnectorManager
{
    ...
    public void Diagnose()
    {
        foreach (var ch in List())
            BridgeHost.Current?.EmitChat(ChatMsg.CreateText(ch.Platform, ch.ChannelId, "system", $"диагностика: канал {ch.ChannelId} активен"));
    }
...
public sealed class StubConnector : IConnector
{
    ...
    public async Task Run()
    {
        ...
        BridgeHost.Current?.EmitChat(ChatMsg.CreateText(_platform, _channel, "system",
