...
public class ChatMsg
{
    ...
    public static ChatMsg CreateText(string platform, string channel, string author, string text, string color)
    {
        var m = new ChatMsg
        {
            Platform = platform, ChannelId = channel, Author = author, Text = text, Color = color,
        };
        m.Parts.Add(new MsgPart { T = "text", V = text });
        return m;
    }
