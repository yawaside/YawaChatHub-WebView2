...
public partial class MainWindow : Window
{
    ...
    private async Task InitializeWebViewAsync()
    {
        ...
        try
        {
            ...
            var core = WebView.CoreWebView2
                ?? throw new InvalidOperationException("CoreWebView2 недоступен после инициализации.");
            ...
            core.Navigate("https://yawachat.invalid/index.html#/app");
        }
        catch (Exception ex)
        {
    ...
    private async Task ConfigureCoreOnceAsync()
    {
        ...
        {
            var ex = new InvalidOperationException($"Процесс WebView2 завершился: {e.ProcessFailedKind}");
            Log(ex.Message);
            ShowFailure(ex);
        });
