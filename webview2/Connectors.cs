...
public sealed class TikTokConnector : IPlatformConnector
{
    ...
    public async Task RunAsync(CancellationToken ct)
    {
        ...
        // ОСНОВНОЙ путь — нативный Webcast WebSocket (без браузера и подписей):
        // чат, подарки, подписки, входы и зрители напрямую из protobuf-потока.
        ...
        {
            ws.Dispose();
            // соединение оборвалось — менеджер перезапустит коннектор с паузой
            throw;
        }
    }
