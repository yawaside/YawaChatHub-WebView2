...
internal static class Program
{
    ...
    public static Task<CoreWebView2Environment> WebViewEnvAsync()
    {
        ...
        {
            // Объединение процессов в диспетчере: GPU и сервисы в одном процессе,
            // общий лимит на рендерер — минимизирует количество msedgewebview2.exe
            // и экономит оперативную память.
            AdditionalBrowserArguments =
                "--renderer-process-limit=1 " +
                "--disable-site-isolation-trials " +
                "--process-per-site " +
                "--disable-features=IsolateOrigins,site-per-process,AudioServiceOutOfProcess,ProcessPerSiteUpToLimit " +
                "--in-process-gpu",
        };
