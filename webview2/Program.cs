...
public sealed class MainWindow : Form
{
    ...
    public MainWindow()
    {
        ...
        // В трее WebView не рисует интерфейс, но приложение и коннекторы живы:
        // официальный Low-режим сбрасывает лишние кэши и RAM.
        VisibleChanged += (_, _) => UpdateWebMemoryTarget();
        FormClosing += (_, e) =>
        {
    ...
    private void UpdateWebMemoryTarget()
    {
        try
        {
