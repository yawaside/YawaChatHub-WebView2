...
internal static class Program
{
    ...
    public static Task<CoreWebView2Environment> WebViewEnvAsync()
    {
        ...
        {
            // Одна общая папка профиля + общий движок: все окна приложения
            // используют один browser-процесс, а рендереры не размножаются
            // по числу вкладок. Флаги штатные и поддерживаются Evergreen.
