...
///   3. redirect_uri — сам loopback (Twitch и VK разрешают http://127.0.0.1).
...
///      может «не дойти». Требование: в консолях Twitch и VK зарегистрированы
///      http://127.0.0.1:8123/oauth … :8126/oauth (без этого площадки
///      отвечают ошибкой redirect_uri / "Security Error").
